...
public class EmpresaService {
  ...
  public String autenticar(Empresa empresa) throws Exception {
		Empresa gerenteExiste = empresaRepository.findByEmail(empresa.getEmail());
		if(gerenteExiste == null) throw new Exception("Email/Senha incorreta");
		boolean passwordIsValid = passwordEncoder.matches(empresa.getSenha(), gerenteExiste.getSenha());
